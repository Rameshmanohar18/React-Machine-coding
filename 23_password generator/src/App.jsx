...
function App() {
  ...
  const generatePassword = () => {
    ...
    for (let i = 0; i < passwordLength; i++) {
      // chars.charAt requires index, and this loop runs from 0 to 19, so for each loop a random character is picked from chars digits
      //  lets say (ex: loop 0, index 10 in random, loop 19, index 1 in random ... so total of 20 digit password is formed from chars digits)
      finalGeneratedPassword += chars.charAt(
